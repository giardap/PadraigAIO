...
export function BuySellModal(props: any) {
    ...
    const slippage = globalSettings.slippage;
    const priorityFee = globalSettings.priorityFee;
    const pool = globalSettings.pool;
    const skipPreflight = globalSettings.skipPreflight;
    const jitoOnly = globalSettings.jitoOnly;
