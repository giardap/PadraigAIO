    ...
    const submit = async () => {
        ...
        try {
            ...
            try {
                ...
                setResponse(`📡 Processing IPFS upload via ${pool === "bonk" ? "bonk.fun" : "pump.fun"} context...`);

                // Step 2: Process upload using the selected pool method
            ...
            <ModalContent style={{ padding: "16px 20px" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: "12px", alignItems: "flex-start" }}>
                    ...
                    <div style={{ width: "100%", marginTop: "12px" }}>
                        <label style={labelStyle}>Launch Platform</label>
                        <select
                            value={pool}
                        ...
                        <Text style={{
                            ...
                            {pool === "pump" ? "Launch on Pump.fun marketplace" : "Launch on Bonk.fun marketplace"}
                        </Text>
                    </div>
